...
public class TeamManager : MonoBehaviour
{
    ...
    public void AddCharacter(CharacterParam param)
    {
        GameObject characterObject = Instantiate(characterPrefab);

        Character character = characterObject.GetComponent<Character>();

        character.InitByMySelf(battleManager);

        characterObject.name = param.name;
        ...
        characterObject.transform.SetParent(character.team == Teams.A ? teamAParent.transform : teamBParent.transform);
